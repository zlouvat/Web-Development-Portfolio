export const carouselData = [
  {
    image: "./src/images/bg_green.jpg",
    label: "HTML",
    text: "Hypertext Markup Language (HTML) is the standard markup language[a] for documents designed to be displayed in a web browser. It defines the content and structure of web content. It is often assisted by technologies such as Cascading Style Sheets (CSS) and scripting languages such as JavaScript, a programming language. ",
  },
  {
    image: "./src/images/bg_pink.jpg",
    label: "HTML",
    text: "Web browsers receive HTML documents from a web server or from local storage and render the documents into multimedia web pages. HTML describes the structure of a web page semantically and originally included cues for its appearance. ",
  },
  {
    image: "./src/images/bg_teal.jpg",
    label: "HTML",
  ...
  },
  {
    image: "./src/images/bg_green.jpg",
    label: "JavaScript",
    text: "JavaScript (/ˈdʒɑːvəskrɪpt/), often abbreviated as JS, is a programming language and core technology of the Web, alongside HTML and CSS. Ninety-nine percent of websites use JavaScript on the client side for webpage behavior.[10]",
  },
  {
    image: "./src/images/bg_pink.jpg",
    label: "JavaScript",
    text: "Web browsers have a dedicated JavaScript engine that executes the client code. These engines are also utilized in some servers and a variety of apps. The most popular runtime system for non-browser usage is Node.js.",
  },
  {
    image: "./src/images/bg_teal.jpg",
    label: "JavaScript",
