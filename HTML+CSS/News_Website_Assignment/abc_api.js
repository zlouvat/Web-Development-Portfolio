const API_URL = "http://feeds.abcnews.com/abcnews/topstories"
    ...
    try {
      ...
      for (let i = 0; i < Math.min(items.length, 9); i++) {
        ...
        const image = document.createElement('img');
            ...
            image.style.width = '400px';  // Adjust image size as needed
            image.style.height = '400px'; // Adjust image size as needed
